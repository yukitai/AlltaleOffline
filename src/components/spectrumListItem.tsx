...
export function SpListItem(params: { id: number, spectrum: SpListItemType }) {
  const spectrum = params.spectrum
  const id = params.id
  return (
    <>
      <a href={`/spec/${id}`} class="block mb-4 border-l-2 py-2 px-3 border-white hover:bg-white/10">
